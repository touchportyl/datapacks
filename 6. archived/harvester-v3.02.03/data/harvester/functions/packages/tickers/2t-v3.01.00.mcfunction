...
# check if sneaking
execute if score VERSION$minecraft.current DatapackManager matches 14 as @a[scores={HV_sneak_time=1..}] at @s align xz positioned ~0.5 ~ ~0.5 run function harvester:root/inventory/hoe
