...
execute as @s at @s store result score @s DD_doorID run data get entity @e[nbt={Item:{components:{"minecraft:custom_data":{DD_Linked:1b}}}},limit=1,sort=nearest] Item.components.minecraft:custom_data.DD_doorID
