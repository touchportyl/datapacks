...
# alerts
execute if score ALERT$mcnotcompatible DatapackManager = BOOL$true DatapackManager run function datapackmanager:tickupdates/alerts/mcnotcompatible
execute if score ALERT$dpbackcompatibility DatapackManager = BOOL$true DatapackManager run function datapackmanager:tickupdates/alerts/dpbackcompatibility
