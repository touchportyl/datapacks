...
#> ground (references: ../modules/enchants/heated/controller)
...
execute as @s[scores={TC_SmeltingTimer=100}] at @s align xyz run function tinkererscraft:modules/enchants/heated/burn_plants
