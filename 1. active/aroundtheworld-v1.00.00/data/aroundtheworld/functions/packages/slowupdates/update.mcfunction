...
# alerts
execute if score ALERT$configurationloaded AroundTheWorld = BOOL$true DatapackManager run function aroundtheworld:packages/alerts/configurationloaded
...
# loops
execute if score LOOP$tickers.1t.isLooping AroundTheWorld = BOOL$false DatapackManager run schedule clear aroundtheworld:packages/tickers/1t-v1.00.00
...
execute if score LOOP$tickers.1s.isLooping AroundTheWorld = BOOL$false DatapackManager run schedule clear aroundtheworld:packages/tickers/1s-v1.00.00
...
# cleanup
scoreboard players operation ALERT$configurationloaded AroundTheWorld = BOOL$false DatapackManager
