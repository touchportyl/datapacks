...
# effect range = 32
execute at @e[tag=DD_portal] if entity @a[distance=..32] run function dimensionaldoors:effects/ambient
...
execute at @e[tag=DD_portal] if entity @a[distance=..7] run function dimensionaldoors:root/detection/portal
