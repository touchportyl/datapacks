...
# code use example:
# execute if CONFIG$addyourown DimensionalDoors = BOOL$true DatapackManager run say "This code runs because addyourown is enabled in the config."
#scoreboard players operation CONFIG$addyourown DimensionalDoors = BOOL$false DatapackManager
...
scoreboard players set VERSION$datapack.current DimensionalDoors 30102
...
scoreboard players set VERSION$minecraft.forward DimensionalDoors 19
