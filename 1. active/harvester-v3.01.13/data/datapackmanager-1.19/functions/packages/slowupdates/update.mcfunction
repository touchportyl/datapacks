...
# loops
execute unless score VERSION$minecraft.current DatapackManager matches 14..19 if score LOOP$tickers.1s.isLooping DatapackManager = BOOL$true DatapackManager run function datapackmanager-1.19:packages/tickers/1s
