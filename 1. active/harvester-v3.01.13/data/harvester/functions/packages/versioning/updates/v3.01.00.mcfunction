...
# notify
tellraw @a [{"text":"","color":"gold","hoverEvent":{"action":"show_text","value":"Alert from Harvester"}},{"text":" +"},{"text":" Harvester ","color":"gold","bold":true,"hoverEvent":{"action":"show_text","value":"Harvest and replant crops efficiently with a hoe!"}},{"text":"v3.01.00","color":"gray"},{"text":" > ","color":"white"},{"text":"Harvester updated from v2.0 to v3.01.00"}]
...
# change
scoreboard objectives modify Harvester displayname [{"text":"Harvester","color":"gold"}]
