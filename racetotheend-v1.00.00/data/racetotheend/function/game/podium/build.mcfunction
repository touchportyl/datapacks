...
fill ~ ~-1 ~ ~ ~-4 ~ minecraft:bedrock replace

# summon text display
execute positioned ~1 ~ ~ as @n[tag=RE_winner] run function racetotheend:game/podium/displaysplits

# summon title
execute positioned ~-14 ~14 ~ run function racetotheend:game/podium/title