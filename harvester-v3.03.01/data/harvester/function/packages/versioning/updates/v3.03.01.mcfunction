...
scoreboard objectives add z_hv_002_t trigger {"text":"Harvester Config Enable Tool Breaking","color":"gray","italic":true}
scoreboard objectives add z_hv_002_f trigger {"text":"Harvester Config Disable Tool Breaking","color":"gray","italic":true}