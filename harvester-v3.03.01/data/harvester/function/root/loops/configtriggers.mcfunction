...
execute as @a if score @s z_hv_002_t matches 1.. run scoreboard players operation CONFIG$toolbreaking Harvester = BOOL$true DatapackManager
execute as @a if score @s z_hv_002_f matches 1.. run scoreboard players operation CONFIG$toolbreaking Harvester = BOOL$false DatapackManager
