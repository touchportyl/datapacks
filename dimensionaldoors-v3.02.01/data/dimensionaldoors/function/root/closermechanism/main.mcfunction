...
# Minecraft 1.16 ++
execute if score VERSION$minecraft.current.minor DatapackManager matches 16.. if block ~ ~ ~ #minecraft:doors[powered=false] run function dimensionaldoors:root/closermechanism/v2
