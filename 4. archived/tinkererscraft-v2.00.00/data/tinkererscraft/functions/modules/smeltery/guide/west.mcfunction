...
#> west (references: ../modules/smeltery/guide)
# The script displays a guide of the west orientation of the multi-block smeltery structure


# fuel layer
#bottom corners (far right - far left - close right - close left)
execute as @s at @s positioned ~-6 ~-1 ~-1 align xyz run particle minecraft:flame ~ ~ ~ 0 0 0 0 1 force
...
execute as @s at @s positioned ~-6 ~-1 ~-1 align xyz run particle minecraft:flame ~ ~0.5 ~ 0 0 0 0 1 force
execute as @s at @s positioned ~-6 ~-1 ~1 align xyz run particle minecraft:flame ~ ~0.5 ~1 0 0 0 0 1 force
execute as @s at @s positioned ~-4 ~-1 ~-1 align xyz run particle minecraft:flame ~1 ~0.5 ~ 0 0 0 0 1 force
execute as @s at @s positioned ~-4 ~-1 ~1 align xyz run particle minecraft:flame ~1 ~0.5 ~1 0 0 0 0 1 force
...
execute as @s at @s positioned ~-4 ~-1 ~-1 align xyz run particle minecraft:flame ~1 ~1 ~ 0 0 0 0 1 force
execute as @s at @s positioned ~-4 ~-1 ~1 align xyz run particle minecraft:flame ~1 ~1 ~1 0 0 0 0 1 force
...
execute as @s at @s positioned ~-6 ~-1 ~ align xyz run particle minecraft:flame ~ ~ ~ 0 0 0 0 1 force
...
execute as @s at @s positioned ~-4 ~-1 ~ align xyz run particle minecraft:flame ~1 ~1 ~ 0 0 0 0 1 force
execute as @s at @s positioned ~-4 ~-1 ~ align xyz run particle minecraft:flame ~1 ~1 ~1 0 0 0 0 1 force
...
execute as @s at @s positioned ~-4 ~1 ~1 align xyz run summon minecraft:falling_block ~0.5 ~ ~0.5 {BlockState:{Name:polished_blackstone_bricks},Tags:["TinkerersCraft","TC_guideBlock"],NoGravity:1b}
execute as @s at @s positioned ~-3 ~1 ~ align xyz run summon minecraft:falling_block ~0.5 ~ ~0.5 {BlockState:{Name:lever,Properties:{facing:east}},Tags:["TinkerersCraft","TC_guideBlock"],NoGravity:1b}
