...
scoreboard players set $config.versioning.minecraft.current DatapackManager 18
scoreboard players set $config.versioning.minecraft.forward DatapackManager 18
