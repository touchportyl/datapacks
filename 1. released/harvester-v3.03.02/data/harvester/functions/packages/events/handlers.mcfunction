...
execute if score EVENT$command.config.handled Harvester = BOOL$false DatapackManager if score EVENT$command.config Harvester = BOOL$true DatapackManager as @a[tag=DM_command_config] at @s run function harvester:packages/events/command/config
...
# uninstall command
execute if score EVENT$command.uninstall.handled Harvester = BOOL$false DatapackManager if score EVENT$command.uninstall Harvester = BOOL$true DatapackManager as @a[tag=DM_command_uninstall] at @s run function harvester:packages/events/command/uninstall
