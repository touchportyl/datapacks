# notify
tellraw @a [{"text":"","color":"gray"},{"text":" + ","color":"green"},{"text":"Harvester","color":"gold"},{"text":" >","color":"white"},{"text":" Initialized."}]
...
execute if score VERSION$minecraft.current.minor DatapackManager matches 14..15 run scoreboard objectives add HV_sneak_time minecraft.custom:minecraft.sneak_time [{"text":"Sneak Detection for Harvester","color":"gold"}]
execute if score VERSION$minecraft.current.minor DatapackManager matches 16.. run scoreboard objectives remove HV_sneak_time
