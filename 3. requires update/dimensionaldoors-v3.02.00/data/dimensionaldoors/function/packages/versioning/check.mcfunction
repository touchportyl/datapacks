...
#execute unless score VERSION$datapack.latest DimensionalDoors matches 10100.. run function dimensionaldoors:packages/versioning/updates/v3.01.00

# set minor version
#execute unless score VERSION$datapack.latest DimensionalDoors matches 10003.. run scoreboard players set VERSION$datapack.latest DimensionalDoors 10003
