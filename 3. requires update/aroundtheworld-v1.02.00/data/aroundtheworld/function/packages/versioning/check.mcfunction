...
#execute unless score VERSION$datapack.latest AroundTheWorld matches 10100.. run function aroundtheworld:packages/versioning/updates/v3.01.00

# set minor version
#execute unless score VERSION$datapack.latest AroundTheWorld matches 10003.. run scoreboard players set VERSION$datapack.latest AroundTheWorld 10003
