...
# notify
tellraw @a [{"text":"","color":"green","hoverEvent":{"action":"show_text","value":"Alert from Tinkerer's Craft"}},{"text":" +"},{"text":" Tinkerer's Craft ","color":"gold","bold":true,"hoverEvent":{"action":"show_text","value":"Metallurgy and metal casting brought to Minecraft! Cast your own equipment out of newly discovered alloys!"}},{"text":"v2.06.02","color":"gray"},{"text":" > ","color":"white"},{"text":"Tinkerer's Craft updated from v2.00.00 to v2.06.00"}]
...
# give updated book
execute as @a[advancements={tinkererscraft:root=true}] run trigger TC_give set 1
