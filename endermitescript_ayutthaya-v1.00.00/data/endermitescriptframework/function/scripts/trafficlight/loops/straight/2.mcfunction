...
# traffic light
function endermitescriptframework:scripts/trafficlight/structure/trafficlight/set_red
# walk signal
function endermitescriptframework:scripts/trafficlight/structure/walksignal/set_red

# schedule next
schedule function endermitescriptframework:scripts/trafficlight/loops/straight/3 2s