...
execute unless score $tc.skipped TC_temp_tests matches 1.. run tellraw @a [{"text":"> ","color":"gray"},{"score":{"name":"$tc.copper.skipped","objective":"TC_temp_tests"}},{"text":" tests skipped"}]
execute if score $tc.skipped TC_temp_tests matches 1 run tellraw @a [{"text":"> Skipped "},{"score":{"name":"$tc.copper.skipped","objective":"TC_temp_tests"}},{"text":" test"}]
execute if score $tc.skipped TC_temp_tests matches 2.. run tellraw @a [{"text":"> Skipped "},{"score":{"name":"$tc.copper.skipped","objective":"TC_temp_tests"}},{"text":" tests"}]
