...
# filter out slag
tag @e[tag=TC_smelting,tag=!TC_copperore,tag=!TC_copper,tag=!TC_copperblock,tag=!TC_exposedcopperblock,tag=!TC_weatheredcopperblock,tag=!TC_oxidisedcopperblock,tag=!TC_cutcopper,tag=!TC_exposedcutcopper,tag=!TC_weatheredcutcopper,tag=!TC_oxidisedcutcopper,tag=!TC_cutcopperstairs,tag=!TC_exposedcutcopperstairs,tag=!TC_weatheredcutcopperstairs,tag=!TC_oxidisedcutcopperstairs,tag=!TC_cutcopperslab,tag=!TC_exposedcutcopperslab,tag=!TC_weatheredcutcopperslab,tag=!TC_oxidisedcutcopperslab,tag=!TC_ironore,tag=!TC_deepslateironore,tag=!TC_iron,tag=!TC_ironblock,tag=!TC_goldore,tag=!TC_deepslategoldore,tag=!TC_nethergoldore,tag=!TC_gold,tag=!TC_goldblock,tag=!TC_obsidian] add TC_slag
