...
execute as @e[tag=TC_oxidisedcopperblock] at @s as @e[tag=TC_smeltery,distance=..2] at @s run function tinkererscraft:modules/smeltery/ui/override/copper
...
execute as @e[tag=TC_oxidisedcutcopper] at @s as @e[tag=TC_smeltery,distance=..2] at @s run function tinkererscraft:modules/smeltery/ui/override/copper
...
execute as @e[tag=TC_oxidisedcutcopperstairs] at @s as @e[tag=TC_smeltery,distance=..2] at @s run function tinkererscraft:modules/smeltery/ui/override/copper
...
execute as @e[tag=TC_oxidisedcutcopperslab] at @s as @e[tag=TC_smeltery,distance=..2] at @s run function tinkererscraft:modules/smeltery/ui/override/copper
