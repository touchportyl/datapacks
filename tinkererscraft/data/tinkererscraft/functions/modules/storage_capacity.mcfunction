...
execute as @s[scores={TC_lIron=4097..}] as @e[type=player,distance=..7,sort=nearest] run advancement grant @s only tinkererscraft:tinkerers_craft/reach_capacity
execute as @s[scores={TC_lGold=4097..}] as @e[type=player,distance=..7,sort=nearest] run advancement grant @s only tinkererscraft:tinkerers_craft/reach_capacity
execute as @s[scores={TC_lObsidian=4097..}] as @e[type=player,distance=..7,sort=nearest] run advancement grant @s only tinkererscraft:tinkerers_craft/reach_capacity
execute as @s[scores={TC_lIrgol=4097..}] as @e[type=player,distance=..7,sort=nearest] run advancement grant @s only tinkererscraft:tinkerers_craft/reach_capacity
execute as @s[scores={TC_lObdiam=4097..}] as @e[type=player,distance=..7,sort=nearest] run advancement grant @s only tinkererscraft:tinkerers_craft/reach_capacity

# advancement on full capacity
execute as @s[scores={TC_lIron=4096,TC_lGold=4096,TC_lObsidian=4096,TC_lIrgol=4096,TC_lObdiam=4096}] as @e[type=player,distance=..7,sort=nearest] run advancement grant @s only tinkererscraft:tinkerers_craft/reach_full_capacity
