...
function datapackmanager-1.21:root/datapackcounter/decrement
...
# disable datapack
datapack disable "file/portyltrident-v1.00.03.zip"
datapack disable "file/portyltrident-v1.00.03"