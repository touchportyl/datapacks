...
execute as @s[tag=TC_outputirgol,tag=TC_anvil,tag=TC_pickaxe,scores={TC_OutputTimer=80..}] at @s run summon minecraft:item ^ ^ ^2 {Motion:[0.0,0.15,0.0],Item:{id:"minecraft:golden_pickaxe",Count:1,tag:{TC_Casted:1b,TC_Alloy:1b,display:{Name:'{"text":"Irgol Pickaxe","color":"gold","italic":"false"}',Lore:['','{"text":" ➥ Casted","color":"dark_gray","italic":"false"}','{"text":" ➥ Prospector","color":"dark_gray","italic":"false"}']},Enchantments:[{id:"minecraft:unbreaking",lvl:59s},{id:"minecraft:efficiency",lvl:3s},{id:"minecraft:fortune",lvl:2s},{id:"minecraft:sharpness",lvl:7s}],HideFlags:1,RepairCost:2147483648}},Tags:["TinkerersCraft","TC_justcasted"],PickupDelay:50}
...
execute as @s[tag=TC_outputirgol,tag=TC_anvil,tag=TC_sword,scores={TC_OutputTimer=80..}] at @s run summon minecraft:item ^ ^ ^2 {Motion:[0.0,0.15,0.0],Item:{id:"minecraft:golden_sword",Count:1,tag:{TC_Casted:1b,TC_Alloy:1b,TC_Riptide:1b,display:{Name:'{"text":"Irgol Sword","color":"gold","italic":"false"}',Lore:['','{"text":" ➥ Casted","color":"dark_gray","italic":"false"}','{"text":" ➥ Prospector","color":"dark_gray","italic":"false"}','{"text":" ➥ Riptide","color":"dark_gray","italic":"false"}']},Enchantments:[{id:"minecraft:unbreaking",lvl:59s},{id:"minecraft:sharpness",lvl:7s},{id:"minecraft:looting",lvl:2s}],HideFlags:1,RepairCost:2147483648}},Tags:["TinkerersCraft","TC_justcasted"],PickupDelay:50}
...
execute as @s[tag=TC_outputirgol,tag=TC_anvil,tag=TC_axe,scores={TC_OutputTimer=80..}] at @s run summon minecraft:item ^ ^ ^2 {Motion:[0.0,0.15,0.0],Item:{id:"minecraft:golden_axe",Count:1,tag:{TC_Casted:1b,TC_Alloy:1b,display:{Name:'{"text":"Irgol Axe","color":"gold","italic":"false"}',Lore:['','{"text":" ➥ Casted","color":"dark_gray","italic":"false"}','{"text":" ➥ Prospector","color":"dark_gray","italic":"false"}']},Enchantments:[{id:"minecraft:unbreaking",lvl:59s},{id:"minecraft:efficiency",lvl:3s},{id:"minecraft:fortune",lvl:2s},{id:"minecraft:sharpness",lvl:5s}],HideFlags:1,RepairCost:2147483648}},Tags:["TinkerersCraft","TC_justcasted"],PickupDelay:50}
...
execute as @s[tag=TC_outputirgol,tag=TC_anvil,tag=TC_shovel,scores={TC_OutputTimer=80..}] at @s run summon minecraft:item ^ ^ ^2 {Motion:[0.0,0.15,0.0],Item:{id:"minecraft:golden_shovel",Count:1,tag:{TC_Casted:1b,TC_Alloy:1b,display:{Name:'{"text":"Irgol Shovel","color":"gold","italic":"false"}',Lore:['','{"text":" ➥ Casted","color":"dark_gray","italic":"false"}','{"text":" ➥ Prospector","color":"dark_gray","italic":"false"}']},Enchantments:[{id:"minecraft:unbreaking",lvl:59s},{id:"minecraft:efficiency",lvl:3s},{id:"minecraft:fortune",lvl:2s},{id:"minecraft:sharpness",lvl:7s}],HideFlags:1,RepairCost:2147483648}},Tags:["TinkerersCraft","TC_justcasted"],PickupDelay:50}
...
execute as @s[tag=TC_outputirgol,tag=TC_anvil,tag=TC_hoe,scores={TC_OutputTimer=80..}] at @s run summon minecraft:item ^ ^ ^2 {Motion:[0.0,0.15,0.0],Item:{id:"minecraft:golden_hoe",Count:1,tag:{TC_Casted:1b,TC_Alloy:1b,display:{Name:'{"text":"Irgol Hoe","color":"gold","italic":"false"}',Lore:['','{"text":" ➥ Casted","color":"dark_gray","italic":"false"}','{"text":" ➥ Prospector","color":"dark_gray","italic":"false"}']},Enchantments:[{id:"minecraft:unbreaking",lvl:59s}],HideFlags:1,RepairCost:2147483648}},Tags:["TinkerersCraft","TC_justcasted"],PickupDelay:50}
