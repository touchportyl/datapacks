...
# version checker
execute unless score $global.version TP_version matches 113.. run function tinkererscraft:packages/version_checker/1.13
execute unless score $global.version TP_version matches 114.. run function tinkererscraft:packages/version_checker/1.14
execute unless score $global.version TP_version matches 115.. run function tinkererscraft:packages/version_checker/1.15
execute unless score $global.version TP_version matches 116.. run function tinkererscraft:packages/version_checker/1.16
...
execute unless score $global.version TP_version matches 116.. run datapack disable "file/tinkererscraft"
