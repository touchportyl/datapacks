...
scoreboard players operation CONFIG$hooks.isEnabled Seaskipper = BOOL$false DatapackManager
...
scoreboard players set VERSION$minecraft.backward Seaskipper 21
