...
execute if score CONFIG$disableparticles DimensionalDoors = BOOL$false DatapackManager if score VERSION$minecraft.current DatapackManager matches 14..15 run particle minecraft:underwater ~ ~0.55 ~ 0.2 0.2 0.2 0 10 normal
