# displays a guide of the south orientation of the multi-block smeltery structure
...
execute as @s at @s positioned ~1 ~1 ~-1 align xyz run summon minecraft:falling_block ~0.5 ~ ~0.5 {BlockState:{Name:"polished_blackstone_bricks"},Tags:["TinkerersCraft","TC_guideBlock"],NoGravity:1b}
execute as @s at @s positioned ~ ~1 ~-2 align xyz run summon minecraft:falling_block ~0.5 ~ ~0.5 {BlockState:{Name:"lever",Properties:{facing:north}},Tags:["TinkerersCraft","TC_guideBlock"],NoGravity:1b}
