...
execute as @s[scores={TC_lIron=4096,TC_lGold=4096,TC_lObsidian=4096,TC_lIrgol=4096,TC_lObdiam=4096}] at @s run advancement grant @e[type=player,distance=..7,sort=nearest] only tinkererscraft:smeltery/capacity/max
