...
scoreboard players set VERSION$datapack.current PortylTrident 10005

# set the backward and forward compatible minecraft versions
scoreboard players set VERSION$minecraft.backward PortylTrident 11404
scoreboard players set VERSION$minecraft.forward PortylTrident 12108
