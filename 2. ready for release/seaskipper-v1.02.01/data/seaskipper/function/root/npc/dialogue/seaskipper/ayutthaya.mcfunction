...
tellraw @s[tag=!SS_ignore] [{"text":"","click_event":{"action":"run_command","command":"/trigger z_ss_dlg_0003"}},{"text":"  >> "},{"text":"Asoka","color":"red","underlined":true}]
tellraw @s[tag=!SS_ignore] [{"text":"","click_event":{"action":"run_command","command":"/trigger z_ss_dlg_0004"}},{"text":"  >> "},{"text":"Mangystau","color":"red","underlined":true}]
