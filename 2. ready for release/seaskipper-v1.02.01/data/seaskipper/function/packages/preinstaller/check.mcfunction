...
scoreboard players set VERSION$datapack.current Seaskipper 10201

# set the backward and forward compatible minecraft versions
scoreboard players set VERSION$minecraft.backward Seaskipper 11700
scoreboard players set VERSION$minecraft.forward Seaskipper 12110
