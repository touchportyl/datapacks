...
execute unless score VERSION$datapack.latest Seaskipper matches 10201.. run function seaskipper:packages/versioning/updates/v1.02.01

# set minor version
#execute unless score VERSION$datapack.latest Seaskipper matches 10201.. run scoreboard players set VERSION$datapack.latest Seaskipper 10201
