# doors
execute if block ~ ~ ~ minecraft:oak_door run function dimensionaldoors:root/closermechanism/v1/oak
execute if block ~ ~ ~ minecraft:iron_door run function dimensionaldoors:root/closermechanism/v1/iron
execute if block ~ ~ ~ minecraft:spruce_door run function dimensionaldoors:root/closermechanism/v1/spruce
execute if block ~ ~ ~ minecraft:birch_door run function dimensionaldoors:root/closermechanism/v1/birch
