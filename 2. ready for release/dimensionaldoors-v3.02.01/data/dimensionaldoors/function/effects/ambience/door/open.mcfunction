...
execute if score VERSION$minecraft.current.minor DatapackManager matches 14..15 if entity @s[tag=DD_NS] run particle minecraft:underwater ~ ~ ~ 0.12 0.26 0.02 0 300 normal
...
execute if score VERSION$minecraft.current.minor DatapackManager matches 14..15 if entity @s[tag=DD_EW] run particle minecraft:underwater ~ ~ ~ 0.02 0.26 0.12 0 300 normal
