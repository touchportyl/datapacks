...
# install msg
tellraw @a [{"text":""},{"text":" +","color":"green"},{"text":" [Tinkerer's Craft] ","color":"aqua","hoverEvent":{"action":"show_text","value":"As if the nether update wasn't enough."}},{"text":"v2.2.0"},{"text":" installed successfully","color":"gray"}]
