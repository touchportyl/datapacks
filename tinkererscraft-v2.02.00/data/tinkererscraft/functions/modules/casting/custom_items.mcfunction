...
execute as @s[tag=TC_outputcopper,tag=TC_anvil,tag=TC_pickaxe,scores={TC_OutputTimer=60..}] at @s run summon minecraft:item ^ ^ ^2 {Motion:[0.0,0.15,0.0],Item:{id:"minecraft:wooden_pickaxe",Count:1,tag:{TC_Casted:1b,display:{Name:'{"text":"Copper Pickaxe","color":"gold","italic":"false"}',Lore:['','{"text":" ➥ Casted","color":"dark_gray","italic":"false"}','{"text":" ➥ Weathering","color":"dark_gray","italic":"false"}']},Enchantments:[{id:"minecraft:sharpness",lvl:1s},{id:"minecraft:efficiency",lvl:2s}],HideFlags:1,RepairCost:2147483648}},Tags:["TinkerersCraft","TC_justcasted"],PickupDelay:50}
...
execute as @s[tag=TC_outputcopper,tag=TC_anvil,tag=TC_sword,scores={TC_OutputTimer=60..}] at @s run summon minecraft:item ^ ^ ^2 {Motion:[0.0,0.15,0.0],Item:{id:"minecraft:wooden_sword",Count:1,tag:{TC_Casted:1b,TC_Lunge:1b,display:{Name:'{"text":"Copper Sword","color":"gold","italic":"false"}',Lore:['','{"text":" ➥ Casted","color":"dark_gray","italic":"false"}','{"text":" ➥ Weathering","color":"dark_gray","italic":"false"}','{"text":" ➥ Lunge","color":"dark_gray","italic":"false"}']},Enchantments:[{id:"minecraft:sharpness",lvl:1s}],HideFlags:1,RepairCost:2147483648}},Tags:["TinkerersCraft","TC_justcasted"],PickupDelay:50}
...
execute as @s[tag=TC_outputcopper,tag=TC_anvil,tag=TC_axe,scores={TC_OutputTimer=60..}] at @s run summon minecraft:item ^ ^ ^2 {Motion:[0.0,0.15,0.0],Item:{id:"minecraft:wooden_axe",Count:1,tag:{TC_Casted:1b,display:{Name:'{"text":"Copper Axe","color":"gold","italic":"false"}',Lore:['','{"text":" ➥ Casted","color":"dark_gray","italic":"false"}','{"text":" ➥ Weathering","color":"dark_gray","italic":"false"}']},Enchantments:[{id:"minecraft:sharpness",lvl:1s},{id:"minecraft:efficiency",lvl:2s}],HideFlags:1,RepairCost:2147483648}},Tags:["TinkerersCraft","TC_justcasted"],PickupDelay:50}
...
execute as @s[tag=TC_outputcopper,tag=TC_anvil,tag=TC_shovel,scores={TC_OutputTimer=60..}] at @s run summon minecraft:item ^ ^ ^2 {Motion:[0.0,0.15,0.0],Item:{id:"minecraft:wooden_shovel",Count:1,tag:{TC_Casted:1b,display:{Name:'{"text":"Copper Shovel","color":"gold","italic":"false"}',Lore:['','{"text":" ➥ Casted","color":"dark_gray","italic":"false"}','{"text":" ➥ Weathering","color":"dark_gray","italic":"false"}']},Enchantments:[{id:"minecraft:sharpness",lvl:1s},{id:"minecraft:efficiency",lvl:2s}],HideFlags:1,RepairCost:2147483648}},Tags:["TinkerersCraft","TC_justcasted"],PickupDelay:50}
