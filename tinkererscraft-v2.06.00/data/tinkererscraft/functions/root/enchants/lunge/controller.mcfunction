...
execute as @s[scores={TC_LungeTimer=5..6}] at @s run function tinkererscraft:root/enchants/lunge/status_1
execute as @s[scores={TC_LungeTimer=20..21}] at @s run function tinkererscraft:root/enchants/lunge/status_2
execute as @s[scores={TC_LungeTimer=35..36}] at @s run function tinkererscraft:root/enchants/lunge/status_3
