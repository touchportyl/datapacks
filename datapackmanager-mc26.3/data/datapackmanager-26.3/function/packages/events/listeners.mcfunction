...
execute unless score EVENT$initialize.copy DatapackManager = BOOL$true DatapackManager if score EVENT$initialize DatapackManager = BOOL$true DatapackManager run function datapackmanager-26.3:packages/events/event/initialize/copy
