...
function datapackmanager-26.3:root/core/cleanup
...
function datapackmanager-26.3:packages/versioning/check

# set up commands
function datapackmanager-26.3:root/events/initializecommands
...
execute if score FLAG$isActive DatapackManager = BOOL$true DatapackManager run function datapackmanager-26.3:packages/alerts/minecraftversion

# stop the main loop if the datapack is not active
execute unless score FLAG$isActive DatapackManager = BOOL$true DatapackManager run function datapackmanager-26.3:root/loops/main/stop
