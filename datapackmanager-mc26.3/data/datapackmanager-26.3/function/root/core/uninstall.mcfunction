# alert
function datapackmanager-26.3:packages/alerts/manageruninstalled

# cleanup events
function datapackmanager-26.3:root/events/event/initialize/cleanup
function datapackmanager-26.3:root/events/command/config/cleanup
function datapackmanager-26.3:root/events/command/uninstall/cleanup
