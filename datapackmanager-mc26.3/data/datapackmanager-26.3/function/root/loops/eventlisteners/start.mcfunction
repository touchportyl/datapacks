...
execute if score LOOP$eventlisteners.alreadyactive DatapackManager = BOOL$false DatapackManager run function datapackmanager-26.3:root/loops/eventlisteners
